...
const imagenError = 'https://raw.githubusercontent.com/El-brayan502/img/upload/uploads/cd7539-1771124060505.jpg';
...
const handler = (type, conn, m, comando) => {
    ...
    const msg = {
        ...
        unreg: `📚 *¡𝐒𝐄𝐌𝐏𝐀𝐈!* ¿Usar *${comando}* sin registrarte? ¡Eres un 𝚋𝚊𝚋𝚘𝚜@ sin nombre! ¡Regístrate ya para 𝚗𝚊𝚟𝚎𝚐𝚊𝚛! Usa: *#reg ${m.name || 'TuNombre'}.${Math.floor(Math.random() * 31 + 10)}* ¡O vete a buscar un tesoro en otra parte! 🧭👀`,
